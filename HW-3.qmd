...
**Which features in the data are resolved by the polynomial models?**   

>

**Which features are not resolved?**    

>

**Do the polynomial curves show any artifacts such as oscillations?**   
...
**How do the rms prediction errors compare to the rms prediction error of a multiple regression model on the training set?**        
...
**What are the last five variables to remain in the model?**   
...
**What is the cross validation estimate for the residual standard error?**   
...
**What is the cross validation estimate for the residual standard error now?**   

> 


**Does rescaling lead to a better performing model?**   
...
**Report the MSE and the most influential variables.**   
...
**Report on the remaining variables in the model and the CV MSE**   

> 

**How does this performance compare to ridge and a plain linear model?**   
